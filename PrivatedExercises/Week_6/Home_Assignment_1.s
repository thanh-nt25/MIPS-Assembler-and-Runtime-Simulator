#------------------------------------------------------------------------------
# Home Assignment 1
# TODO	Student need to init an array, and call function mspfx to make a try.
#------------------------------------------------------------------------------
.data
A: .word -2, 6, -1, 3, -2
.text
...
#the base address of this list(A) in $a0 and the number of #elements is stored in a1
